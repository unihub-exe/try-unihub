...
const CreateEvent = () => {
    ...
    return ( <
        ...
        div className = "absolute left-0 top-1/2 transform -translate-y-1/2 h-1 bg-[color:var(--secondary-color)] -z-10 rounded-full transition-all duration-500"
        style = {
            { width: `${((step - 1) / 3) * 100}%` } } >
        < /div>
        ...
        className = "space-y-6 animate-fadeIn" >
        {
            step === 1 && ( <
                ...
                /div> {
                    formData.address && ( <
                        div className = "mt-2 text-xs text-gray-500 flex items-start gap-1 bg-blue-50 p-2 rounded-lg" >
                        <
                        FiMapPin className = "mt-0.5 text-blue-500 shrink-0" / > { formData.address } <
                        /div>
                    )
                } <
                /div> <
                ...
                className = "w-5 h-5 rounded text-[color:var(--secondary-color)] focus:ring-[color:var(--secondary-color)]" /
                >
                <
        ...
        {
            step === 3 && ( <
                div className = "space-y-6 animate-fadeIn" > { /* Tickets Section */ } <
                div >
                <
                ...
                div className = "space-y-3" > {
                    formData.ticketTypes.map((ticket, idx) => ( <
                        div key = { idx }
                        className = "p-4 rounded-xl border border-gray-200 bg-white shadow-sm hover:shadow-md transition-shadow relative group" >
                        <
                ...
                /span> <
                /label> <
                label className = "flex items-center gap-3 cursor-pointer bg-yellow-50 p-3 rounded-lg border border-yellow-200" >
                <
                input type = "checkbox"
                ...
                Promote this Event(Premium) <
                /span> <
                span className = "text-xs text-gray-600" >
                Your event will be highlighted and appear at the top of feeds. <
                /span> <
                /div> <
                /label> <
                /div> <
...

        {
            step === 4 && ( <
                ...
                Profile Image <
                /label> <
                div className = { `relative h-48 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center transition-all ${
                      uploading.profile
                        ? "opacity-50"
                ...
                > {
                    uploading.profile && ( <
                        ...
                        <
                        div className = "animate-spin rounded-full h-8 w-8 border-b-2 border-[color:var(--secondary-color)]" > < /div> <
                        /div>
                    )
                } <
                /div> { /* Image URL input hidden - only upload allowed */ } <
                input type = "hidden"
                name = "profile"
