      ...
      <div className="bg-white border border-gray-100 shadow-2xl rounded-3xl overflow-hidden">
        <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-10 relative">
            ...
            <div
              className="absolute left-0 top-1/2 transform -translate-y-1/2 h-1 bg-[color:var(--secondary-color)] -z-10 rounded-full transition-all duration-500"
                      ...
                      <label className="flex items-center gap-3 cursor-pointer bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-gray-600">
                            Your event will be highlighted and appear at the top
                            of feeds.
                          </span>
                        </div>
                      </label>
            ...
            {step === 4 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-fadeIn">
                <div>
                  ...
                  <div
                    className={`relative h-48 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center transition-all ${
                      uploading.profile
                        ? "opacity-50"
                  ...
                  <input
                    ...
                    className="mt-2 w-full px-3 py-2 rounded-lg bg-white border border-gray-200 text-xs focus:border-[color:var(--secondary-color)] outline-none"
                  />
                </div>
