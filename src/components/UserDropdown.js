    ...
    return ( <
        ...
        div className = "relative h-8 w-8 rounded-full overflow-hidden bg-[color:var(--secondary-color)]" > {
            userAvatar ? ( <
                ...
                div className = "h-full w-full flex items-center justify-center text-white font-bold text-sm" > { userInitials } <
                /div>
            )
        } <
        /div> <
        span className = "text-sm font-medium text-gray-700 hidden sm:block max-w-[100px] truncate" > { userData ? .username || userData ? .displayName || "User" } <
        /span> <
            ...
            showDropdown && ( <
                ...
                div className = "relative h-12 w-12 rounded-full overflow-hidden bg-[color:var(--secondary-color)] shrink-0" > {
                    userAvatar ? ( <
                        ...
                        div className = "h-full w-full flex items-center justify-center text-white font-bold" > { userInitials } <
                        /div>
                    )
                } <
                /div> <
                ...
                <
                p className = "font-bold text-gray-900 truncate" > { userData ? .username || userData ? .displayName || "User" } <
                /p> <
                p className = "text-xs text-gray-500 truncate" > { userData ? .email } < /p> {
                    userData ? .role && ( <
                        span className = "mt-1.5 inline-flex items-center px-2 py-0.5 text-[10px] font-bold tracking-wide uppercase text-[color:var(--primary-color)] bg-[color:var(--primary-color)]/10 rounded-full" > { userData.role } <
                        /span>
                    )
                } <
                /div> <
